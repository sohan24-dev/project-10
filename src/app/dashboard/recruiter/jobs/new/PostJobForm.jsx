...
export default function PostJobForm({ company }) {
    ...
    const handleSubmit = async (e) => {
        ...
        setErrors({});
        // console.log("Form data to submit:", company._id);
        ...
        <div className="min-h-screen bg-[#0d0d0e] text-white py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-[#121214] border border-zinc-900 rounded-xl p-8 shadow-2xl">
                ...
                </div>
                {
                    ...
                    <div className="bg-yellow-900/30 border border-yellow-800 text-yellow-400 rounded-lg p-4 mb-6">
                        <p className="text-sm">Your company profile is currently <span className="font-semibold">{company.status}</span>. You must have an approved company profile to post jobs. Please contact support if you believe this is an error.</p>
                    </div>
